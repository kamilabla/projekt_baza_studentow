...
- **Main website**
  On the main page we have a choice to choose one of the subpages.
...
<img width="799" alt="image" src="https://github.com/user-attachments/assets/893b57ca-58b9-4ab8-8325-8855daacb9e8">
  ...
  The same in 'Pracownik' tab.

  <img width="794" alt="image" src="https://github.com/user-attachments/assets/9ccacfc5-e738-4549-9a5d-403dc29f408e">


- **Adding new users**  
  This formular allows to insert information like: name, surname, date of registration and a name of the student's group.
...
- **Student's details**  
  View presenting detail information about a student.
...
- **Multilanguage app (internationalization)**  
